...
class WormGearCalculator : ViewModel() {
    ...
    fun calculateResults(
        ...
        return listOf(
            ...
            ResultItem("Teilkreisdurchmesser Rad d_2", String.format("%.4f", d_2), "mm"),
            ...
            ResultItem("Mittensteigungswinkel γ", String.format("%.4f", gamma_degrees), "°"),
            ResultItem("Normale Teilung p_n", String.format("%.4f", p_n), "mm"),
            ResultItem("Axialteilung p_x", String.format("%.4f", p_x), "mm"),
            ResultItem("Schneckenganghöhe p_z", String.format("%.4f", p_z), "mm"),
            ResultItem("Kopfkreisdurchmesser Rad da_2", String.format("%.4f", da_2), "mm"),
            ResultItem("Zahnfußhöhe Rad hfm_2", String.format("%.4f", hfm_2), "mm"),
            ResultItem("Fußkreisdurchmesser Rad df_2", String.format("%.4f", df_2), "mm"),
            ResultItem("Kopfhöhe Rad ha_2", String.format("%.4f", ha_2), "mm"),
            ResultItem("Zahnhöhe Rad h_2", String.format("%.4f", h_2), "mm"),
            ResultItem("Kopfkreisdurchmesser Schnecke da_1", String.format("%.4f", da_1), "mm"),
            ResultItem("Fußkreisdurchmesser Schnecke df_1", String.format("%.4f", df_1), "mm"),
            ResultItem("Wirkdurchmesser d_w1", String.format("%.4f", d_w1), "mm"),
            ResultItem("Steigungswinkel Wirkdurchmesser γ_w", String.format("%.4f", gamma_w_degrees), "°"),
            ResultItem("Eingriffsteilung p_et", String.format("%.4f", p_et), "mm"),
            ResultItem("Überdeckungsgrad ε_α", String.format("%.4f", epsilon_alpha), ""),
        )
    }
