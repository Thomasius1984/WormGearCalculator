...
class WormGearCalculator : ViewModel() {
    ...
    fun calculateResults(
        ...
        return listOf(ResultItem("Axialmodul mₓ",String.format("%.${NUMBER_PRECISION}f", resultm_x), "mm"),
            ...
            ResultItem("Profilverschiebungsfaktor Rad xf₂",String.format("%.${NUMBER_PRECISION}f", resultx_f),""),
            ResultItem("Profilverschiebung Rad xₘ",String.format("%.${NUMBER_PRECISION}f", resultx_m), "mm"),
